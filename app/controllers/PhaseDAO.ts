...
export const phaseDAO = function(router: any){
	router.post('/getPhases',function(req: any,res: any){
		getPhases(req)
	...
	router.post('/updatePhase',function(req: any,res: any){
		updatePhase(req)
