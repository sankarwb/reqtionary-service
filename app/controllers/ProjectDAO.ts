...
function getAllProjects(req: any) {
	return new Promise((resolve,reject) => {
		...
		function callback(err: any, rows: any, fields: any) {
			if(err){
				...
				let response: any = [],projectVO: any = {};
...
export const getAppProject = function (req: any){
	return new Promise(function(resolve,reject) {
...
function getProjectDetails(req: any){
	return new Promise(function(resolve,reject){
