...
export const releaseDAO = function (router: any) {

	router.post('/getReleases',(req: any,res: any) => {
	...
	router.post('/getReleasesProjects',(req: any,res: any) => {
		...
		function callback(err: any, rows: any, fields: any) {
			if(err){
				...
				var response: any = [], releaseVO: any = {};
...
export const getSupressedRelease = function(orgId: any, modifiedByID: any){
