...
export const divisionDAO = function (router: any) {
	router.post('/getDivisions',function(req: any,res: any){
	...
	router.post('/updateDivision',function(req: any,res: any){
		updateDivision(req)
			.then(function(results){
				res.json(results);
			},function(error){
...
function updateDivision(req: any){
...
function getDivisions(req: any){
	return new Promise(function(resolve,reject){
		...
		function callback(err: any, rows: any, fields: any) {
			var response: any = [],divisionVO: any = {};
			if(err){
